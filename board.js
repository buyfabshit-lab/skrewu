...
const TOOLS = {
  ...
  camo:      { name: 'Camo Tool',       desc: 'Fill any logo with 169 seamless camo patterns.', href: 'tools-library/camo-tool/index.html', status: 'live' },
...
const CAPS = {
  ...
  camo:      [['Fill logo with selected camo','browser'], ['Add stroke inside/center/outside','browser'], ['Export result as PNG','browser'], ['Save to client locker','supabase']],
